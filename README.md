# Diffusion Policy
python train.py --config-dir=. --config-name=image_multi_task_diffusion_policy_transformer.yaml training.seed=42 training.device=cuda:0 hydra.run.dir='/mnt/hdd1/ego4d_proj/data/outputs/${now:%Y.%m.%d}/${now:%H.%M.%S}_${name}_${task_name}'
