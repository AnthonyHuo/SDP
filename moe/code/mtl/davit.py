...
@BACKBONES.register_module()
def DaViT_large_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dims=(192, 384, 768, 1536), num_heads=(6, 12, 24, 48),
        depths=(1, 1, 9, 1), mlp_ratio=4., overlapped_patch=False, **kwargs)
    print(model_kwargs)
    return _create_transformer('DaViT_224', pretrained=pretrained, **model_kwargs)
...
@BACKBONES.register_module()
def DaViT_large_384(pretrained=False, **kwargs):
    model_kwargs = dict(
